...
export const sources: Source[] = [
  ...
  { name: 'Model Releases', kind: 'rss', url: 'https://news.google.com/rss/search?q=%22GPT-5.5%22+OR+%22GPT-5%22+OR+%22Claude+Opus%22+OR+%22Claude+Sonnet%22+OR+%22Gemini+3%22+OR+%22Llama+4%22+OR+%22DeepSeek%22+when:3d&hl=en-US&gl=US&ceid=US:en', category: 'news', weight: 1.4 },
  { name: 'Dev Tool Releases', kind: 'rss', url: 'https://news.google.com/rss/search?q=%22claude+code%22+OR+%22cursor%22+OR+%22github+copilot%22+OR+%22cline%22+OR+%22aider%22+OR+%22coding+agent%22+OR+%22MCP%22+when:3d&hl=en-US&gl=US&ceid=US:en', category: 'news', weight: 1.3 },
